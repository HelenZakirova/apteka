...
namespace apteka
{
    public partial class lekarstva : Form
    {
        ...
        {
            string query = "SELECT id_lekarstva, nazvanie, proizvoditel, cena FROM lekarstva";
        ...
        private void button2_Click(object sender, EventArgs e) //Добавить
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("insert into lekarstva(id_lekarstva, nazvanie, proizvoditel, cena) value('" + textBox1.Text + "','" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "');", conn);
                conn.Open();
                cmd.ExecuteReader();
                conn.Close();
                getinfo();
        ...
        private void button3_Click(object sender, EventArgs e) //Обновить
        {
            ...
            {
                MySqlConnection conn = new MySqlConnection("Server=localhost;Database=apteka;User=root;Password=2375425;");
                MySqlCommand cmd = new MySqlCommand("update lekarstva set id_lekarstva ='" + textBox1.Text + "', nazvanie = '" + textBox2.Text + "', proizvoditel = '" + textBox3.Text + "', cena = '" + textBox4.Text + "' where id_lekarstva =" + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";", conn);
                Console.WriteLine("update lekarstva set id_lekarstva ='" + textBox1.Text + "', nazvanie = '" + textBox2.Text + "', proizvoditel = '" + textBox3.Text + "', cena = '" + textBox4.Text + "' where id_lekarstva =" + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";");
                conn.Open();
                cmd.ExecuteReader();
                conn.Close();
                getinfo();
        ...
        private void button4_Click(object sender, EventArgs e) //Удалить
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                {
                    string del = "delete from lekarstva where id_lekarstva = " + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";";
                    do_Action(del);
                    getinfo();
                }
            }
